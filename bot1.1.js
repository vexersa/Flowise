...
function R(t) {
    ...
    t.fn && (M(t), e = f, r = b, s = v, function(t, e, r) {
        ...
        try {
            ...
            return t.pure && (t.state = u, t.owned && t.owned.forEach(M), t.owned = null), t.updatedAt = r + 1, z(e)
...
const kt = t => null == t,
    ...
    Ct = async t => {
        try {
            var e = "string" == typeof t ? t : t.url,
                r = await fetch(e, {
                    ...
                    mode: "cors",
                    headers: "string" != typeof t && _t(t.body) ? {
                        "Content-Type": "application/json"
                    } : void 0,
                    body: "string" != typeof t && _t(t.body) ? JSON.stringify(t.body) : void 0
                }),
                s = await r.json();
            if (r.ok) return {
                data: s
    ...
    }, St = st('<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">'), At = st('<img alt="Bubble button icon">'), Ot = st('<button part="button"><svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.601 8.39897C18.269 8.06702 17.7309 8.06702 17.3989 8.39897L12 13.7979L6.60099 8.39897C6.26904 8.06702 5.73086 8.06702 5.39891 8.39897C5.06696 8.73091 5.06696 9.2691 5.39891 9.60105L11.3989 15.601C11.7309 15.933 12.269 15.933 12.601 15.601L18.601 9.60105C18.9329 9.2691 18.9329 8.73091 18.601 8.39897Z">'), Et = t => {
        {
            const e = Ot(),
                r = e.firstChild;
            return e.$$click = () => t.toggleBot(), e.style.setProperty("z-index", "42424242"), ct(e, F(X, {
                get when() {
                    return kt(t.customIconSrc)
                },
                keyed: !0,
                get children() {
                    const e = St();
        ...
        body: r
    })), Rt = st('<input class="focus:outline-none bg-transparent px-4 py-4 flex-1 w-full text-input" type="text">'), $t = t => {
        const [e, r] = Y(t, ["ref", "onInput"]);
        return (s = Rt()).$$input = t => e.onInput(t.currentTarget.value), "function" == typeof(n = t.ref) ? lt(n, s) : t.ref = s, s.style.setProperty("font-size", "16px"), at(s, r, !1, !1), s;
        var s, n
    }, Tt = (nt(["input"]), st('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="19px"><path d="M476.59 227.05l-.16-.07L49.35 49.84A23.56 23.56 0 0027.14 52 24.65 24.65 0 0016 72.59v113.29a24 24 0 0019.52 23.57l232.93 43.07a4 4 0 010 7.86L35.53 303.45A24 24 0 0016 327v113.31A23.57 23.57 0 0026.59 460a23.94 23.94 0 0013.22 4 24.55 24.55 0 009.52-1.93L476.4 285.94l.19-.09a32 32 0 000-58.8z">')), Bt = t => {
        return at(e = Tt(), V({
            get style() {
                return {
                    fill: t.color ?? "#3B81F6"
        ...
        var e
    }, Lt = st('<button type="submit">'), jt = st('<svg><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">'), Nt = t => {
        return at(e = Lt(), V({
            get disabled() {
        ...
        var e
    }, [Mt, zt] = x(), qt = st("<span>Send"), Dt = st('<div class="flex items-end justify-between pr-2 chatbot-input w-full" data-testid="input">'), Ft = t => {
        ...
        {
            const r = Dt();
            return r.$$keydown = i, r.style.setProperty("border-top", "1px solid #eeeeee"), r.style.setProperty("width", "90%"), r.style.setProperty("position", "absolute"), r.style.setProperty("bottom", "40px"), r.style.setProperty("margin", "auto"), r.style.setProperty("z-index", "1000"), ct(r, F($t, {
                ref(t) {
    ...
    }, Gt = (nt(["keydown"]), st('<figure data-testid="default-avatar"><svg width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0" x="0" y="0" mask-type="alpha"><circle cx="37.5" cy="37.5" r="37.5" fill="#0042DA"></circle></mask><g mask="url(#mask0)"><rect x="-30" y="-43" width="131" height="154" fill="#0042DA"></rect><rect x="2.50413" y="120.333" width="81.5597" height="86.4577" rx="2.5" transform="rotate(-52.6423 2.50413 120.333)" stroke="#FED23D" stroke-width="5"></rect><circle cx="76.5" cy="-1.5" r="29" stroke="#FF8E20" stroke-width="5"></circle><path d="M-49.8224 22L-15.5 -40.7879L18.8224 22H-49.8224Z" stroke="#F7F8FF" stroke-width="5">')), Ht = () => {
        {
            const t = Gt(),
                e = t.firstChild;
            return k((r => {
                var s = "flex justify-center items-center rounded-full text-white relative " + (Mt() ? "w-6 h-6 text-sm" : "w-10 h-10 text-xl"),
                    n = "absolute top-0 left-0 " + (Mt() ? " w-6 h-6 text-sm" : "w-full h-full text-xl");
        ...
        return _((() => {
            ...
            get children() {
                const t = Ut(),
                    r = t.firstChild;
                return k((s => {
                    var n = "flex justify-center items-center rounded-full text-white relative flex-shrink-0 " + (Mt() ? "w-6 h-6 text-sm" : "w-10 h-10 text-xl"),
                        o = e();
...
function Zt(t, e) {
    if (e) {
        if (Wt.test(t)) return t.replace(Xt, (t => Kt[t]))
    } else if (Jt.test(t)) return t.replace(Qt, (t => Kt[t]));
    return t
}
...
var ee;
(ee = vt = vt || {})[ee.space = 1] = "space", ee[ee.text = 2] = "text", ee[ee.paragraph = 3] = "paragraph", ee[ee.heading = 4] = "heading", ee[ee.listStart = 5] = "listStart", ee[ee.listEnd = 6] = "listEnd", ee[ee.looseItemStart = 7] = "looseItemStart", ee[ee.looseItemEnd = 8] = "looseItemEnd", ee[ee.listItemStart = 9] = "listItemStart", ee[ee.listItemEnd = 10] = "listItemEnd", ee[ee.blockquoteStart = 11] = "blockquoteStart", ee[ee.blockquoteEnd = 12] = "blockquoteEnd", ee[ee.code = 13] = "code", ee[ee.table = 14] = "table", ee[ee.html = 15] = "html", ee[ee.hr = 16] = "hr";
class re {
    constructor(t) {
        this.options = t || oe.options
    }
    code(t, e, r, s) {
...
class se {
    constructor(t, e, r = oe.options, s) {
        if (this.staticThis = t, this.links = e, this.options = r, this.renderer = s || this.options.renderer || new re(this.options), !this.links) throw new Error("InlineLexer requires 'links' parameter.");
        this.setRules()
    }
    static output(t, e, r) {
...
se.rulesBase = null, se.rulesPedantic = null, se.rulesGfm = null, se.rulesBreaks = null;
class ne {
    constructor(t) {
        this.simpleRenderers = [], this.line = 0, this.tokens = [], this.token = null, this.options = t || oe.options, this.renderer = this.options.renderer || new re(this.options)
    }
    static parse(t, e, r) {
        return new this(r).parse(e, t)
    }
    parse(t, e) {
        this.inlineLexer = new se(se, t, this.options, this.renderer), this.tokens = e.reverse();
        let r = "";
    ...
    parseText() {
        ...
        for (var e;
            (e = this.getNextElement()) && e.type == vt.text;) t += "\n" + this.next().text;
    ...
    tok() {
        switch (this.token.type) {
            ...
            case vt.listStart: {
                let e = "";
                for (var t = this.token.ordered; this.next().type != vt.listEnd;) e += this.tok();
                return this.renderer.list(e, t)
            }
            case vt.listItemStart: {
                let t = "";
                for (; this.next().type != vt.listItemEnd;) t += this.token.type == vt.text ? this.parseText() : this.tok();
...
class oe {
    ...
    static setBlockRule(t, e = (() => "")) {
        return ie.simpleRules.push(t), this.simpleRenderers.push(e), this
    }
    ...
    static debug(t, e = this.options) {
        ...
        let s = t.slice();
        return (e = new ne(e)).simpleRenderers = this.simpleRenderers, e = e.debug(r, t), {
            tokens: s = s.map((t => {
    ...
    static callBlockLexer(t = "", e) {
        ...
        return t = t.replace(/\r\n|\r/g, "\n").replace(/\t/g, "    ").replace(/\u00a0/g, " ").replace(/\u2424/g, "\n").replace(/^ +$/gm, ""), ie.lex(t, e, !0)
    }
    static callParser(t, e, r) {
        var s;
        return this.simpleRenderers.length ? ((s = new ne(r)).simpleRenderers = this.simpleRenderers, s.parse(e, t)) : ne.parse(t, e, r)
    }
    static callMe(t) {
...
oe.options = new class {
    constructor() {
        this.gfm = !0, this.tables = !0, this.breaks = !1, this.pedantic = !1, this.sanitize = !1, this.mangle = !0, this.smartLists = !1, this.silent = !1, this.langPrefix = "lang-", this.smartypants = !1, this.headerPrefix = "", this.xhtml = !1, this.escape = Zt, this.unescape = te
    }
}, oe.simpleRenderers = [];
class ie {
    constructor(t, e) {
        this.staticThis = t, this.links = {}, this.tokens = [], this.options = e || oe.options, this.setRules()
    }
    static lex(t, e, r, s) {
...
ie.simpleRules = [], ie.rulesBase = null, ie.rulesGfm = null, ie.rulesTables = null;
const ae = st('<div class="flex justify-end mb-2 items-end guest-container"><span class="px-4 py-2 mr-2 whitespace-pre-wrap max-w-full chatbot-guest-bubble" data-testid="guest-bubble">'),
    le = (oe.setOptions({
        isNoP: !0
    }), t => {
        let e;
        A((() => {
            e && (e.innerHTML = oe.parse(t.message))
        }));
        {
            const r = ae(),
                s = r.firstChild;
    ...
    ce = st('<div class="flex justify-start mb-2 items-start host-container"><span class="px-4 py-2 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">'),
    he = (oe.setOptions({
        isNoP: !0
    }), t => {
        let e;
    ...
    ue = st('<div class="flex items-center"><div class="w-2 h-2 mr-1 rounded-full bubble1"></div><div class="w-2 h-2 mr-1 rounded-full bubble2"></div><div class="w-2 h-2 rounded-full bubble3">'),
    pe = () => ue(),
    de = st('<div class="flex justify-start mb-2 items-start animate-fade-in host-container"><span class="px-4 py-4 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">'),
    fe = () => {
        return ct((t = de()).firstChild, F(pe, {})), t;
        var t
    },
    ge = st('<div data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="flex justify-start mb-2 items-start animate-fade-in host-container hover:brightness-90 active:brightness-75"><span class="px-2 py-1 ml-1 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">'),
    be = t => {
        return r = (e = ge()).firstChild, e.$$click = () => t.onSourceClick?.(), r.style.setProperty("width", "80px"), r.style.setProperty("font-size", "13px"), r.style.setProperty("border-radius", "15px"), r.style.setProperty("cursor", "pointer"), r.style.setProperty("text-overflow", "ellipsis"), r.style.setProperty("overflow", "hidden"), r.style.setProperty("white-space", "nowrap"), ct(r, (() => t.pageContent)), e;
        var e, r
    },
    ye = (nt(["click"]), st('<span>Built by <a href="https://known.consulting/ai-agents/?utm_source=chat-constitution&utm_medium=footer-link&utm_campaign=ai-agents&utm_id=ai-agents" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Known.')),
    me = "#303235",
    ve = t => {
        let e, r;
        const s = r => {
        ...
        }));
        {
            ...
            return "function" == typeof e ? lt(e, s) : e = s, s.style.setProperty("font-weight", "bold"), k((e => {
                var n = t.poweredByTextColor ?? me,
                    o = t.badgeBackgroundColor ?? "#ffffff",
                    i = t.poweredByTextColor ?? me;
    ...
    xe = (we.open = "0", we.close = "1", we.ping = "2", we.pong = "3", we.message = "4", we.upgrade = "5", we.noop = "6", Object.create(null)),
    ke = (Object.keys(we).forEach((t => {
        xe[we[t]] = t
    })), {
        type: "error",
        data: "parser error"
    }),
    _e = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Object.prototype.toString.call(Blob),
    Ce = "function" == typeof ArrayBuffer,
    Se = ({
        type: t,
        data: e
    }, r, s) => _e && e instanceof Blob ? r ? s(e) : Ae(e, s) : Ce && (e instanceof ArrayBuffer || (t => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t && t.buffer instanceof ArrayBuffer)(e)) ? r ? s(e) : Ae(new Blob([e]), s) : s(we[t] + (e || "")),
    Ae = (t, e) => {
    ...
    Ee = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256);
for (let t = 0; t < 64; t++) Ee[Oe.charCodeAt(t)] = t;
const Pe = "function" == typeof ArrayBuffer,
    Re = (t, e) => {
        var r;
    ...
    $e = (t, e) => {
        ...
        return Pe ? (r = (t => {
            ...
            var c = new ArrayBuffer(i),
                h = new Uint8Array(c);
            for (e = 0; e < a; e += 4) r = Ee[t.charCodeAt(e)], s = Ee[t.charCodeAt(e + 1)], n = Ee[t.charCodeAt(e + 2)], o = Ee[t.charCodeAt(e + 3)], h[l++] = r << 2 | s >> 4, h[l++] = (15 & s) << 4 | n >> 2, h[l++] = (3 & n) << 6 | 63 & o;
            return c
        })(t), Te(r, e)) : {
            base64: !0,
            data: t
    ...
    Te = (t, e) => "blob" === e && t instanceof ArrayBuffer ? new Blob([t]) : t,
    Be = String.fromCharCode(30);

function Le(t) {
    if (t) return function(t) {
        for (var e in Le.prototype) t[e] = Le.prototype[e];
        return t
    }(t)
}
Le.prototype.on = Le.prototype.addEventListener = function(t, e) {
    ...
    return this
}, Le.prototype.emitReserved = Le.prototype.emit, Le.prototype.listeners = function(t) {
    return this._callbacks = this._callbacks || {}, this._callbacks["$" + t] || []
}, Le.prototype.hasListeners = function(t) {
    return !!this.listeners(t).length
};
const je = "undefined" != typeof self ? self : "undefined" != typeof window ? window : Function("return this")();

function Ne(t, ...e) {
    return e.reduce(((e, r) => (t.hasOwnProperty(r) && (e[r] = t[r]), e)), {})
}
const Ie = je.setTimeout,
    Me = je.clearTimeout;

function ze(t, e) {
    e.useNativeTimers ? (t.setTimeoutFn = Ie.bind(je), t.clearTimeoutFn = Me.bind(je)) : (t.setTimeoutFn = je.setTimeout.bind(je), t.clearTimeoutFn = je.clearTimeout.bind(je))
}
...
class Fe extends Le {
    ...
    onError(t, e, r) {
        return super.emitReserved("error", new De(t, e, r)), this
    }
    open() {
...
function Xe(t) {
    let e = "";
    for (; e = Ge[t % He] + e, 0 < (t = Math.floor(t / He)););
    return e
}
...
function tr(t) {
    t = t.xdomain;
    try {
        if ("undefined" != typeof XMLHttpRequest && (!t || Ze)) return new XMLHttpRequest
    } catch (t) {}
    if (!t) try {
...
function er() {}
const rr = null != new tr({
    xdomain: !1
}).responseType;
class sr extends Le {
    constructor(t, e) {
        super(), ze(this, e), this.opts = e, this.method = e.method || "GET", this.uri = t, this.async = !1 !== e.async, this.data = void 0 !== e.data ? e.data : null, this.create()
    }
    create() {
        var t = Ne(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
        t.xdomain = !!this.opts.xd, t.xscheme = !!this.opts.xs;
        const e = this.xhr = new tr(t);
        try {
        ...
        "undefined" != typeof document && (this.index = sr.requestsCount++, sr.requests[this.index] = this)
    }
    onError(t) {
    ...
    cleanup(t) {
        if (void 0 !== this.xhr && null !== this.xhr) {
            if (this.xhr.onreadystatechange = er, t) try {
                this.xhr.abort()
            } catch (t) {}
            "undefined" != typeof document && delete sr.requests[this.index], this.xhr = null
        }
    }
    onLoad() {
...
if (sr.requestsCount = 0, sr.requests = {}, "undefined" != typeof document)
    if ("function" == typeof attachEvent) attachEvent("onunload", nr);
    else if ("function" == typeof addEventListener) {
    addEventListener("onpagehide" in je ? "pagehide" : "unload", nr, !1)
}

function nr() {
    for (var t in sr.requests) sr.requests.hasOwnProperty(t) && sr.requests[t].abort()
}
const or = "function" == typeof Promise && "function" == typeof Promise.resolve ? t => Promise.resolve().then(t) : (t, e) => e(t, 0),
    ir = je.WebSocket || je.MozWebSocket,
    ar = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
const lr = {
        websocket: class extends Fe {
            ...
            doOpen() {
                if (this.check()) {
                    var t = this.uri(),
                        ...
                        r = ar ? {} : Ne(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
                    this.opts.extraHeaders && (r.headers = this.opts.extraHeaders);
                    try {
                        this.ws = ar ? new ir(t, e, r) : e ? new ir(t, e) : new ir(t)
                    } catch (t) {
            ...
            uri() {
                ...
                let r = "";
                return this.opts.port && ("wss" == e && 443 !== Number(this.opts.port) || "ws" == e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port), this.opts.timestampRequests && (t[this.opts.timestampParam] = Ke()), this.supportsBinary || (t.b64 = 1), t = Je(t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + (t.length ? "?" + t : "")
            }
            check() {
                return !!ir
            }
        },
        polling: class extends Fe {
            constructor(t) {
                ...
                e = t && t.forceBase64, this.supportsBinary = rr && !e
            }
            get name() {
                return "polling"
            }
            ...
            uri() {
                ...
                let r = "";
                return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = Ke()), this.supportsBinary || t.sid || (t.b64 = 1), this.opts.port && ("https" == e && 443 !== Number(this.opts.port) || "http" == e && 80 !== Number(this.opts.port)) && (r = ":" + this.opts.port), t = Je(t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + r + this.opts.path + (t.length ? "?" + t : "")
            }
            request(t = {}) {
                return Object.assign(t, {
                    xd: this.xd,
                    xs: this.xs
                }, this.opts), new sr(this.uri(), t)
            }
            doWrite(t, e) {
                (t = this.request({
                    method: "POST",
    ...
    cr = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
...
let pr = class t extends Le {
    constructor(t, e = {}) {
        super(), this.writeBuffer = [], t && "object" == typeof t && (e = t, t = null), t ? (t = ur(t), e.hostname = t.host, e.secure = "https" === t.protocol || "wss" === t.protocol, e.port = t.port, t.query && (e.query = t.query)) : e.host && (e.hostname = ur(e.host).host), ze(this, e), this.secure = null != e.secure ? e.secure : "undefined" != typeof location && "https:" === location.protocol, e.hostname && !e.port && (e.port = this.secure ? "443" : "80"), this.hostname = e.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), this.port = e.port || ("undefined" != typeof location && location.port ? location.port : this.secure ? "443" : "80"), this.transports = e.transports || ["polling", "websocket"], this.writeBuffer = [], this.prevBufferLen = 0, this.opts = Object.assign({
            path: "/engine.io",
            agent: !1,
            withCredentials: !1,
            upgrade: !0,
    ...
    getWritablePackets() {
        if (this.maxPayload && "polling" === this.transport.name && 1 < this.writeBuffer.length) {
            ...
            for (let r = 0; r < this.writeBuffer.length; r++) {
                ...
                if (t && (e += qe(t)), 0 < r && e > this.maxPayload) return this.writeBuffer.slice(0, r);
                e += 2
            }
        }
...
pr.protocol = 4;
const dr = "function" == typeof ArrayBuffer,
    fr = t => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer,
    gr = Object.prototype.toString,
    br = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === gr.call(Blob),
    yr = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === gr.call(File);

function mr(t) {
    return dr && (t instanceof ArrayBuffer || fr(t)) || br && t instanceof Blob || yr && t instanceof File
}
...
function vr(t, e) {
    if (t && "object" == typeof t)
        if (Array.isArray(t)) {
            ...
            if (mr(t)) return !0;
            if (t.toJSON && "function" == typeof t.toJSON && 1 === arguments.length) return vr(t.toJSON(), !0);
            for (const e in t)
                if (Object.prototype.hasOwnProperty.call(t, e) && vr(t[e])) return !0
        } return !1
}
...
function wr(t) {
    var e = [],
        r = t.data;
    return t.data = xr(r, e), t.attachments = e.length, {
        packet: t,
        buffers: e
    }
}
...
function xr(t, e) {
    ...
    if (Array.isArray(t)) {
        ...
        for (let r = 0; r < t.length; r++) s[r] = xr(t[r], e);
        return s
    }
    if ("object" != typeof t || t instanceof Date) return t;
    var n = {};
    for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && (n[r] = xr(t[r], e));
    return n
}

function kr(t, e) {
    return t.data = _r(t.data, e), delete t.attachments, t
}
...
function _r(t, e) {
    if (t) {
        ...
        if (Array.isArray(t))
            for (let r = 0; r < t.length; r++) t[r] = _r(t[r], e);
        else if ("object" == typeof t)
            for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && (t[r] = _r(t[r], e))
    }
    return t
}
const Cr = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"];
! function(t) {
...
class Ar extends Le {
    ...
    add(t) {
        ...
        if ("string" == typeof t) {
            ...
            (!r && e.type !== wt.BINARY_ACK || (e.type = r ? wt.EVENT : wt.ACK, this.reconstructor = new Or(e), 0 === e.attachments)) && super.emitReserved("decoded", e)
        } else {
            if (!mr(t) && !t.base64) throw new Error("Unknown type: " + t);
    ...
    decodeString(t) {
        ...
        if (void 0 === wt[r.type]) throw new Error("unknown packet type " + r.type);
        ...
        if (t.charAt(++e)) {
            if (s = this.tryParse(t.substr(e)), !Ar.isPayloadValid(r.type, s)) throw new Error("invalid payload");
            r.data = s
        }
        return r
    }
    ...
    static isPayloadValid(t, e) {
        switch (t) {
            ...
            case wt.CONNECT_ERROR:
                return "string" == typeof e || Sr(e);
            case wt.EVENT:
            case wt.BINARY_EVENT:
                return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === Cr.indexOf(e[0]));
            case wt.ACK:
            case wt.BINARY_ACK:
...
class Or {
    ...
    takeBinaryData(t) {
        return this.buffers.push(t), this.buffers.length === this.reconPack.attachments ? (t = kr(this.reconPack, this.buffers), this.finishedReconstruction(), t) : null
    }
...
var Er = Object.freeze({
    ...
    Encoder: class {
        ...
        encode(t) {
            return t.type !== wt.EVENT && t.type !== wt.ACK || !vr(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
        ...
        encodeAsString(t) {
            let e = "" + t.type;
            return t.type !== wt.BINARY_EVENT && t.type !== wt.BINARY_ACK || (e += t.attachments + "-"), t.nsp && "/" !== t.nsp && (e += t.nsp + ","), null != t.id && (e += t.id), null != t.data && (e += JSON.stringify(t.data, this.replacer)), e
        }
        encodeAsBinary(t) {
            t = wr(t);
...
class $r extends Le {
    ...
    subEvents() {
        var t;
        this.subs || (t = this.io, this.subs = [Pr(t, "open", this.onopen.bind(this)), Pr(t, "packet", this.onpacket.bind(this)), Pr(t, "error", this.onerror.bind(this)), Pr(t, "close", this.onclose.bind(this))])
    }
    get active() {
        return !!this.subs
    }
...
class Br extends Le {
    constructor(t, e) {
        super(), this.nsps = {}, this.subs = [], t && "object" == typeof t && (e = t, t = void 0), (e = e || {}).path = e.path || "/socket.io", this.opts = e, ze(this, e), this.reconnection(!1 !== e.reconnection), this.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e.reconnectionDelay || 1e3), this.reconnectionDelayMax(e.reconnectionDelayMax || 5e3), this.randomizationFactor(null != (r = e.randomizationFactor) ? r : .5), this.backoff = new Tr({
    ...
    open(t) {
        if (!~this._readyState.indexOf("open")) {
            ...
            const s = this.engine,
                n = this,
                o = (this._readyState = "opening", this.skipReconnect = !1, Pr(s, "open", (function() {
                    n.onopen(), t && t()
                })));
            var e = Pr(s, "error", (e => {
    ...
    socket(t, e) {
        let r = this.nsps[t];
        return r ? this._autoConnect && !r.active && r.connect() : (r = new $r(this, t, e), this.nsps[t] = r), r
    }
    _destroy(t) {
...
function jr(t, e) {
    ...
    t = function(t, e = "", r) {
        let s = t;
        return r = r || "undefined" != typeof location && location, "string" == typeof(t = null == t ? r.protocol + "//" + r.host : t) && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? r.protocol + t : r.host + t), /^(https?|wss?):\/\//.test(t) || (t = void 0 !== r ? r.protocol + "//" + t : "https://" + t), s = ur(t)), s.port || (/^(http|ws)$/.test(s.protocol) ? s.port = "80" : /^(http|ws)s$/.test(s.protocol) && (s.port = "443")), s.path = s.path || "/", t = -1 !== s.host.indexOf(":") ? "[" + s.host + "]" : s.host, s.id = s.protocol + "://" + t + ":" + s.port + e, s.href = s.protocol + "://" + t + (r && r.port === s.port ? "" : ":" + s.port), s
    }(t, (e = e || {}).path || "/socket.io");
    var r = t.source,
        s = t.id,
        n = t.path;
    n = Lr[s] && n in Lr[s].nsps;
    let o;
    return o = (n = e.forceNew || e["force new connection"] || !1 === e.multiplex || n) ? new Br(r, e) : (Lr[s] || (Lr[s] = new Br(r, e)), Lr[s]), t.query && !e.query && (e.query = t.queryKey), o.socket(t.path, e)
}
Object.assign(jr, {
    Manager: Br,
    Socket: $r,
...
const zr = t => {
        ...
        return F(X, {
            ...
            get children() {
                return [(ct(n = Nr(), xt), n), (n = Ir(), r = n.firstChild, s = r.nextSibling.nextSibling.firstChild.firstChild, n.style.setProperty("z-index", "1100"), n.addEventListener("click", i), ct(r, xt), s.style.setProperty("background-color", "transparent"), s.style.setProperty("margin-left", "20px"), s.style.setProperty("margin-right", "20px"), s.addEventListener("click", o), s.addEventListener("pointerdown", o), ct(s, (() => {
                    const r = C((() => !!t.value));
                    return () => {
                        return r() && (s = (t = Mr()).firstChild, t.style.setProperty("background", "white"), t.style.setProperty("margin", "auto"), t.style.setProperty("padding", "7px"), "function" == typeof(n = e) ? lt(n, s) : e = s, t);
                        var t, s, n
                    }
                })()), n)];
                var r, s, n
    ...
    qr = st('<div><div class="flex w-full h-full justify-center"><div class="overflow-y-scroll w-full min-h-full px-3 pt-10 relative scrollable-container chatbot-chat-view scroll-smooth">'),
    Dr = st("<div>"),
    Fr = st('<div class="w-full h-32">'),
    Gr = "Hi there! How can I help?",
    Hr = t => {
        let e, r, s;
        const [n, o] = x(""), [i, a] = x(!1), [l, c] = x(!1), [h, u] = x({}), [p, d] = x([{
            message: t.welcomeMessage ?? Gr,
            type: "apiMessage"
        }], {
            equals: !1
        }), [f, g] = x(""), [b, y] = x(!1), m = (A((() => {
            ...
            if (o(e), "" !== e.trim()) {
                ...
                var r, s = {
                    question: e,
                    history: p().filter((e => e.message !== t.welcomeMessage ?? Gr))
                };
        ...
        return _((() => {
            ...
            const o = qr(),
                ...
                l = a.firstChild;
            var h;
            return "function" == typeof(h = ("function" == typeof(h = s) ? lt(h, o) : s = o, e)) ? lt(h, l) : e = l, l.style.setProperty("padding-bottom", "100px"), ct(l, F(W, {
                get each() {
                    return [...p()]
                },
                children: (e, r) => [C((() => {
                    ...
                    return () => {
                        return t() && ((r = Dr()).style.setProperty("display", "flex"), r.style.setProperty("flex-direction", "row"), r.style.setProperty("width", "100%"), ct(r, F(W, {
                            get each() {
    ...
    Ur = t => {
        return e = Fr(), "function" == typeof(r = t.ref) ? lt(r, e) : t.ref = e, e;
        var e, r
    },
    Vr = st("<style>"),
    Yr = st('<div part="bot">'),
    Wr = t => {
        const [e] = Y(t, ["theme"]), [r, s] = x(!1), [n, o] = x(!1), [i, a] = x("700"), [l, c] = x("400");
        var h;
        return A((() => {
            e.theme?.chatWindow?.height && a(e.theme?.chatWindow?.height?.toString()), e.theme?.chatWindow?.width && c(e.theme?.chatWindow?.width?.toString())
        })), [(ct(h = Vr(), xt), h), F(Et, V((() => e.theme?.button), {
            toggleBot: () => {
                r() ? s(!1) : (n() || o(!0), s(!0))
            },
            get isBotOpened() {
            ...
            return s.style.setProperty("transition", "transform 200ms cubic-bezier(0, 1.2, 1, 1), opacity 150ms ease-out"), s.style.setProperty("transform-origin", "bottom right"), s.style.setProperty("box-shadow", "rgb(0 0 0 / 16%) 0px 5px 40px"), s.style.setProperty("z-index", "42424242"), ct(s, F(X, {
                ...
                var o = i() + "px",
                    ...
                    h = e.theme?.chatWindow?.backgroundColor || "#ffffff",
                    u = `fixed sm:right-5 rounded-lg w-full sm:w-[${l()}px] max-h-[${i()}px]` + (r() ? " opacity-1" : " opacity-0 pointer-events-none") + ("large" === t.theme?.button?.size ? " bottom-24" : " bottom-20");
                return o !== n._v$ && (null != (n._v$ = o) ? s.style.setProperty("height", o) : s.style.removeProperty("height")), a !== n._v$2 && (null != (n._v$2 = a) ? s.style.setProperty("width", a) : s.style.removeProperty("width")), c !== n._v$3 && (null != (n._v$3 = c) ? s.style.setProperty("transform", c) : s.style.removeProperty("transform")), h !== n._v$4 && (null != (n._v$4 = h) ? s.style.setProperty("background-color", h) : s.style.removeProperty("background-color")), u !== n._v$5 && it(s, n._v$5 = u), n
            }), {
                _v$: void 0,
                _v$2: void 0,
                _v$3: void 0,
    ...
    Kr = ("undefined" != typeof window && function(t, e, r) {
        2 === arguments.length && (r = e, e = {}), i(t, e)(yt(r))
    }("flowise-chatbot", mt, Wr), {
        init: Xr
    });
(t => {
